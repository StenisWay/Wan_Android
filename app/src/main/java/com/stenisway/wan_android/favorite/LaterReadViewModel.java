...
public class LaterReadViewModel extends AndroidViewModel {

    private final ItemsRepository repository;

    public LaterReadViewModel(@NonNull Application application) {
        super(application);
        repository = ItemsRepository.getInstance(application);
    }

    public LiveData<List<New_Item>> getLaterList(){
        return repository.useNewItemMethod(GetMethod.SELECT_LATER_READ);
    }
